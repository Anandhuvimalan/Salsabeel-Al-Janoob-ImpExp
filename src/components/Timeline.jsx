  ...
  return (
    ...
    >
      <div className=" px-6 lg:px-10 py-20">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base pr-2 lg:pr-20">
...
Backed by a dedicated leadership team and a skilled workforce, we aim to empower communities, enhance businesses, and build sustainable futures. Whether managing international trade logistics or delivering tailored service solutions, Salsabeel Al Janoob remains at the forefront of innovation and excellence.
      ...
      <div ref={ref} className="relative max-w-7xl pb-20">
        ...
        <div
          ...
          className="absolute md:left-10 lg:left-12 left-8 top-0 overflow-hidden w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-neutral-200 dark:via-neutral-700 to-transparent to-[99%] [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)]"
        >
          <motion.div
